...
find_dependency(QCoro5Coro)
find_dependency(QCoro5Core)


include("${CMAKE_CURRENT_LIST_DIR}/QCoro5NetworkTargets.cmake")

# Versionless target, for compatiblity with Qt6
if (TARGET QCoro5::Network AND NOT TARGET QCoro::Network)
    add_library(QCoro::Network INTERFACE IMPORTED)
    set_target_properties(QCoro::Network PROPERTIES
        INTERFACE_LINK_LIBRARIES "QCoro5::Network"
    )
endif()
